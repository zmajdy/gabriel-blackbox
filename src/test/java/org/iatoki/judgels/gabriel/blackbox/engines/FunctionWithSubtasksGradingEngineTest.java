...
public final class FunctionWithSubtasksGradingEngineTest extends BlackBoxGradingEngineTest {

    private final FunctionWithSubtasksGradingEngine engine;
    ...
    public FunctionWithSubtasksGradingEngineTest() {
        super("function");
        ...
        this.engine = new FunctionWithSubtasksGradingEngine();
    ...
    private FunctionWithSubtasksGradingConfig createConfigWithMainSourceFileAndCustomScorer(String mainSourceFile, String customScorer) {
        return new FunctionWithSubtasksGradingConfig(timeLimit, memoryLimit, testData, subtaskPoints, mainSourceFile, customScorer);
    }
}
