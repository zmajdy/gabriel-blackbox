...
public final class FunctionWithSubtasksGradingEngine extends BlackBoxGradingEngine {
    ...
    public FunctionWithSubtasksGradingEngine() {
    ...
    protected void prepareAlgorithms(BlackBoxGradingConfig config, GradingLanguage language, Map<String, File> sourceFiles, Map<String, File> helperFiles, SandboxFactory sandboxFactory) throws PreparationException {
        FunctionWithSubtasksGradingConfig castConfig = (FunctionWithSubtasksGradingConfig) config;
